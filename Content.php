      ...
      <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <img src="./tree/img/anh11.png" class="d-block w-100" alt="anh11" width="1000" height="450">
            <div class="carousel-caption d-none d-md-block">
              <p>SALE 20%</p>
            </div>
          </div>
          <div class="carousel-item">
            <img src="./tree/img/anh5.png" class="d-block w-100" alt="anh5" width="1000" height="450">
            <div class="carousel-caption d-none d-md-block">
              <p>SALE 50%</p>
            </div>
          </div>
