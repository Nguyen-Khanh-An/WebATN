      ...
      <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="./tree/img/slide3.png" class="d-block w-100" alt="slide1" width="1000" height="500">
          ...
          <div class="carousel-item">
            <img src="./tree/img/slide4.png" class="d-block w-100" alt="slide2" width="1000" height="450">
            <div class="carousel-caption d-none d-md-block">
              <p>SALE 20%</p>
            </div>
          </div>
          <div class="carousel-item">
            <img src="./tree/img/slide2.png" class="d-block w-100" alt="slide3" width="1000" height="450">
            <div class="carousel-caption d-none d-md-block">
              <p>SALE 50%</p>
            </div>
          </div>
